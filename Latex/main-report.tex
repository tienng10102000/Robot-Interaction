...
\def \TITLE{Báo cáo Tương Tác Người Máy}
\def \AUTHOR{Nguyễn Mạnh Tiến, Lê Thị Mỹ Tiên, Nguyễn Duy Tân}
...
\graphicspath{{Hinh_figures/}{../Hinh_figures/}} % Thư mục chứa các hình ảnh
...
\subfile{MoDau_Abstract_Overview/MoDau_Abstract_Overview} % Phần mở đầu
